...
export async function POST(request: NextRequest) {
  ...
  const backendUrl = `${BACKEND_API_BASE_URL}/api/v1/memberships`;
  ...
  try {
    ...
    const response = await fetch(backendUrl, {
      ...
      headers: {
        ...
        // Forward any necessary headers, e.g., Authorization if you had it
        ...request.headers,
      },
    ...
    console.error('Proxy POST /api/memberships request failed:', error);
